...
exports.generateLocatorCandidatesWithAI = generateLocatorCandidatesWithAI;
...
function getClient() {
    ...
    if (!client) {
        ...
        Logger_1.Logger.info("[SELF-HEALING] OpenAI client initialized");
    }
    return client;
}
/**
 ...
 */
async function generateLocatorCandidatesWithAI(domSnippet, originalSelector) {
...
`;
    ...
    try {
        ...
        Logger_1.Logger.error(`[SELF-HEALING] Failed to parse AI locators: ${e}. Raw: ${raw}`);
        return [];
    }
}
